...
const documents = [
    ...
    [ 27, 'KJNZDDCDASA' ],
    [ 28, 'sardar dard' ],
    [ 29, 'shit, teoreo naurusy yhii' ],
    [ 30, 'Wow, this is some shit, teoreo naurusy yhii' ],
    [ 31, 'Chal uth bandeya abhi manzil dur hai' ],
    [ 32, 'Bandeya bandeya, Manzil Manzil' ]
  ]
  ;

  const algo = new recommender();
  const data = algo.train(documents);
  const ans = algo.getSimilarDocuments('31',data);
  console.log(ans);